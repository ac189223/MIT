...
public class _061_SimpleDraw extends JPanel implements Runnable {
    ...
    private _063_DrawGraphics draw;


    public _061_SimpleDraw(_063_DrawGraphics drawer) {
        this.draw = drawer;
    }
    ...
    public static void main(String args[]) {
        final _061_SimpleDraw content = new _061_SimpleDraw(new _063_DrawGraphics());
