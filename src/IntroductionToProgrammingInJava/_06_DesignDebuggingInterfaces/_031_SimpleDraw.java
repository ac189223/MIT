...
public class _031_SimpleDraw extends JPanel implements Runnable {
    ...
    private _033_DrawGraphics draw;


    public _031_SimpleDraw(_033_DrawGraphics drawer) {
        this.draw = drawer;
    }
    ...
    public static void main(String args[]) {
        final _031_SimpleDraw content = new _031_SimpleDraw(new _033_DrawGraphics());
